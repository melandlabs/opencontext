...
│                                                                       │
│  2. 👤 User Guide                                                   │
│     Understand the four verbs and temporal memory                     │
│     → 01-user-guide.md                                               │
│                                                                       │
│  3. 🔧 Developer Guide                                              │
...
│                                                                       │
│  6. 🤖 Building Agents                                               │
│     Create AI agents with memory using IAgent                         │
│     → 05-building-agents.md                                           │
│                                                                       │
└─────────────────────────────────────────────────────────────────────┘
```
...
| Build a memory-aware agent | [Building Agents](./05-building-agents.md) |
| Build an agent with tools | [Building Agents](./05-building-agents.md#pattern-3-tool-calling-agent) |
...
| Create custom agent provider | [Building Agents](./05-building-agents.md#creating-a-custom-agent) |
...
| [01-user-guide.md](./01-user-guide.md) | Core Concepts | Four verbs, temporal graph, graceful degradation |
...
| [05-building-agents.md](./05-building-agents.md) | AI Agents | IAgent, StandaloneAgent, custom agents, memory-aware agents |
...
**Next:** Start with [Getting Started](./00-getting-started.md) or jump to [Building Agents](./05-building-agents.md) to create AI agents with memory.
