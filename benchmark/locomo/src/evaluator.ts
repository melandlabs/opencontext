...
import type { LoCoMoSample, EvaluationResult, Prediction, QAPair } from "./types";
import {
 ...
 */
function createMessagesFromDialog(
  sample: LoCoMoSample,
  now: number,
): BenchRawMessage[] {
 ...
 */
function createMessagesFromObservation(
  sample: LoCoMoSample,
  now: number,
): BenchRawMessage[] {
  const messages: BenchRawMessage[] = [];
 ...
 */
function createMessagesFromSummary(
  sample: LoCoMoSample,
  now: number,
): BenchRawMessage[] {
  const messages: BenchRawMessage[] = [];
