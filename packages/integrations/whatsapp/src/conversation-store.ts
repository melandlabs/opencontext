 ...
 * Data persists to ~/.opencontext/memory/whatsapp/YYYY-MM-DD.json
 *
...
class WhatsAppConversationStore {
	...
	addMessage(userId: string, accountId: string, role: "user" | "assistant", content: string): void {
		...
		console.log(`[WhatsAppConversationStore] Added ${role} message for user ${userId}, account ${accountId}`);
	}
	...
	clearConversation(userId: string, accountId: string): void {
		...
		console.log(`[WhatsAppConversationStore] Cleared conversation for user ${userId}, account ${accountId}`);
	}
	...
	clearAllConversations(userId: string): void {
		...
		console.log(`[WhatsAppConversationStore] Cleared all conversations for user ${userId}`);
	}
